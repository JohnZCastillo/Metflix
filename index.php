...
<body>
    ...
    <div class="netflix-container">
        <svg width="867" height="233" viewBox="0 0 867 233" fill="none">
        <g id="M">
            <path id="M1-base" class="base" d="M0 232.8L37 227.8V101.6L35.1 0H0V232.8Z" />
            <path id="M1-shadow" d="M0 232.8L37 227.8V101.6L35.1 0H0V232.8Z" fill="url(#M1-shadowFill)" />
            <path id="M2-base" class="base" d="M52 167.8L89 162.8V101.6L87.1 0H52V232.8Z" />
            <path id="M2-shadow" d="M52 232.8L89 227.8V101.6L87.1 0H52V232.8Z" fill="url(#M2-shadowFill)" />
            <path id="M3-base" class="base" d="M104 232.8L141 227.8V101.6L139.1 0H104V232.8Z" />
            <path id="M3-shadow" d="M104 232.8L141 227.8V101.6L139.1 0H104V232.8Z" fill="url(#M3-shadowFill)" />
            <defs>
                <linearGradient id="M1-shadowFill" x1="80%" y1="0%" x2="50%" y2="100%" gradientUnits="userSpaceOnUse">
                    <stop class="shadow-start" offset="0%" />
                    <stop class="shadow-end" offset="100%" />
                </linearGradient>
                <linearGradient id="M2-shadowFill" x1="60%" y1="0%" x2="50%" y2="100%" gradientUnits="userSpaceOnUse">
                    <stop class="shadow-start" offset="0%" />
                    <stop class="shadow-end" offset="100%" />
                </linearGradient>
                <linearGradient id="M3-shadowFill" x1="70%" y1="0%" x2="50%" y2="100%" gradientUnits="userSpaceOnUse">
                    <stop class="shadow-start" offset="0%" />
                    <stop class="shadow-end" offset="100%" />
                </linearGradient>
            </defs>
